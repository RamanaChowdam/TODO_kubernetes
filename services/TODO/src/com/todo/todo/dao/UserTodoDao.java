...
/**
 * Specifies methods used to obtain and modify UserTodo related information
 * which is stored in the database.
 */
@Repository("TODO.UserTodoDao")
public class UserTodoDao extends WMGenericDaoImpl<UserTodo, Integer> {

    @Autowired
    @Qualifier("TODOTemplate")
    private HibernateTemplate template;

    @Autowired
    @Qualifier("TODOWMQLTypeHelper")
